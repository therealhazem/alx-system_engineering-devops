...
For the containers,everything is run under the root user, which has the ability to run anything as another user.
...
Using what I did for task #1, I make my fix short and sweet.
